...
Adapted from Julia Kukulies' github: https://github.com/JuliaKukulies/precip_efficiency/blob/1.0/microphysics/microphysics_functions.py
...
def height_integration(density, heights, axis = 0):
    ...
    Args:                                                                                                                                                                                      
      mixing ratio(np.array): 3D or 4D field of hydrometeor quantity as density/concentration (i.e. kg/m3)                                                                                       
